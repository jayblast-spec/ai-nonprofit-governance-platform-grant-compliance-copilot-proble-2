...
AI Nonprofit Governance Platform is a Next.js SaaS/web-business seed generated for the `governance_platform` archetype. The public landing page builds trust before the user tries the product. The app page provides the working tool. The pricing page defines the conversion path.
...
- `docs/STITCH_EXPORT_BUNDLE.md`
- `docs/STITCH_REFINEMENT_PROMPTS.md`
- `docs/SAAS_MASS_PRODUCTION_PROTOCOL.md`
- `docs/ELITE_WEBSITE_STANDARD.md`
